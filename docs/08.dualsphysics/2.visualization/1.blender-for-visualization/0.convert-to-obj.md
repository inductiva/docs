...
Next, learn how to visualize the resulting `.obj` files in Blender in the [Rendering in Blender](/guides/dualsphysics/visualization/blender-for-visualization/render-in-blender) section.
