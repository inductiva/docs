...
description: Step-by-step guide to run your first Delft3D simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First Delft3D Simulation on Inductiva.AI
 description: Step-by-step guide to run your first Delft3D simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
...
⚠️ **Important**: If you change the number of virtual CPUs in the machine, make sure to update the corresponding value in the `mpirun` command (e.g., `-np 4`).
