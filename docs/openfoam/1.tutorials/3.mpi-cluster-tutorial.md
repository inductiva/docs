...
Prefer to create it yourself? Check out our guide on [converting an Allrun script into Python commands](/guides/openfoam/tutorials/convert-allrun-script-into-python-commands).
