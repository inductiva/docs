...
:raw-img{src="/expand/animation.gif" alt="Animation" center}
...
Here’s an example for [run_ising_model.R](/how-it-works/run_ising_model.R){target="_blank"}. The example takes a list of “temperature” values, but you can swap in *any* numeric parameter (reaction rate, 
...
![Magnetization](expand/magnetization_T0_3.0.png)
