...
Running these 54 simulations sequentially took approximately **hours and minutes**.
...
- `-n 55` specifies the number of processes.
- `--mpi-no-spawn` is recommended according to the gprMax documentation to avoid MPI process spawning issues.
-
