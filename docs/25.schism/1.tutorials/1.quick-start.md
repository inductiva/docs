...
description: Step-by-step guide to run your first SCHISM simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First SCHISM Simulation on Inductiva.AI
 description: Step-by-step guide to run your first SCHISM simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
