...
As an example, consider the [3D Dam Break](../1.tutorials/3.run-on-gpu-configuration) tutorial. 
...
![File -> Open](dualsphysics/file-open.png)
<p align="center"><em>Figure 1: File -> Open</em></p>

![Selecting the files](dualsphysics/select-files.png)
...
![Make files visible](dualsphysics/eye.png)
...
![Move the camera to the correct position](dualsphysics/camera.png)
...
![Simulation running](dualsphysics/sim.png)
...
![Changing idp to Vel](dualsphysics/pick_vel.png)
<p align="center"><em>Figure 6: Changing idp to Vel</em></p>

![Simulation running with velocity visible](dualsphysics/sim_vel.png)
