...
description: Step-by-step guide to run your first CP2K simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First CP2K Simulation on Inductiva.AI
 description: Step-by-step guide to run your first CP2K simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
...
:raw-img{src="/cp2k/h2o-64.gif" alt="CP2K simulation visualization" center}
