...
description: Step-by-step guide to run your first FDS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First FDS Simulation on Inductiva.AI
 description: Step-by-step guide to run your first FDS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
