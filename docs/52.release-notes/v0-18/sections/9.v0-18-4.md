...
**Learn more:** Check out the [document](https://inductiva.ai/guides/optimize-workflow/alerts-events/sections/observer-events) for more details. 
...
:raw-img{src="/releases/v0-18/Task_runtime-gif.gif" alt="Task_runtime-gif" center}
...
- Work continues on the mechanism to save the output after a spot instance is preempted feature we previewed [last release](/guides/release-notes/v0-18/v0-18-0). We're making solid progress and expect to share more details very soon. 
