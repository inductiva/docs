...
description: Step-by-step guide to run your first SFINCS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First SFINCS Simulation on Inductiva.AI
 description: Step-by-step guide to run your first SFINCS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
