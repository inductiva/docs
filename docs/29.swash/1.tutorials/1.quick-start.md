...
description: Step-by-step guide to run your first SWASH simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First SWASH Simulation on Inductiva.AI
 description: Step-by-step guide to run your first SWASH simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
