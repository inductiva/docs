...
description: Explore supported Octopus versions and container images on the Inductiva.AI Cloud HPC platform.
seo:
 title: Octopus Versions and Docker Containers on Inductiva.AI
 description: Explore supported Octopus versions and container images on the Inductiva.AI Cloud HPC platform.
---
...
- **16.1** (Jul., 2025) - with GPU support
