...
description: Step-by-step guide to run your first Octopus simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First Octopus Simulation on Inductiva.AI
 description: Step-by-step guide to run your first Octopus simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
