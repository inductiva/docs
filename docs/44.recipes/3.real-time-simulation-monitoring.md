...
> 💡 This example is designed for the [OpenFOAM Quick Start guide](/guides/openfoam/tutorials/quick-start), but it can be easily updated for other simulators. If your simulator uses a different log format, adjust the regular expression in the script accordingly.
