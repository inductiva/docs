...
**Best For:**
- Run the [built-in simulators](/guides/building-blocks/configuring-simulators)
- Automating complex or repetitive workflows 
- Programmatically manage resources and data storage.


> Check the full Python Client documentation [here](/guides/api-functions/api/)
...
> Check out the full CLI documentation [here](/guides/api-functions/cli/)
...
2.  **Operate with the CLI:** Use for quick operational tasks like bulk file deletions, loading custom containers so you can [Bring Your Own Software](/guides/bring-your-own-software/), or checking task status without opening an IDE.
