...
Let’s revisit the `motorBike` case from this [tutorial](/guides/openfoam/tutorials/quick-start). This simulation is split into **8 sub-domains**, meaning it runs with **8 MPI processes**.
