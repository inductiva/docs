---
title: Run AMR-Wind Simulations Across Multiple Machines Using MPI
description: ""
seo:
 title: Run AMR-Wind Simulations Across Multiple Machines Using MPI
 description: This tutorial demonstrates how to run AMR-Wind simulations on a multi-node MPI cluster using the Inductiva platform, enabling you to scale your computations across multiple cloud machines for improved performance.
---
...
```markdown
| Machine Type       | Nº of Machines | vCPUs | Execution Time | Speedup  | Estimated Cost (USD) |
|--------------------|----------------|-------|----------------|----------|----------------------|
| c2d-highmem-112    | 1              | 112   | 144 min        | Baseline | 3.60                 |
| c2d-highmem-112    | 2              | 224   | 90 min         | 1.60x    | 4.82                 |
| c2d-highmem-112    | 4              | 448   | 59 min, 10s    | 2.43x    | 6.94                 |
| c2d-highmem-112    | 8              | 896   | 42 min, 12s    | 3.41x    | 10.87                |
```
