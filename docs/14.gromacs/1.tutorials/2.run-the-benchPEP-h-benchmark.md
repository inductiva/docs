...
![Benchmark plot sorted by execution time](gromacs/benchPEP-h_duration.png)

![Benchmark plot sorted by estimated cost](gromacs/benchPEP-h_cost.png)

![Cost vs Time plot](gromacs/benchPEP-h_cost_vs_duration.png)
...
benchmark = benchmarks.Benchmark(name="gromacs_benchPEP-h") \
