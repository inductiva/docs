...
description: Step-by-step guide to run your first WRF simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First WRF Simulation on Inductiva.AI
 description: Step-by-step guide to run your first WRF simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
...
:raw-img{src="/wrf/RAINNC_animation.gif" alt="Animation with the RAINNC values of the simulation." center}
