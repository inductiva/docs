...
Here’s an example for [run_ising_model.R](how-it-works/run_ising_model.R). The example takes a list of “temperature” values, but you can swap in *any* numeric parameter (reaction rate, 
