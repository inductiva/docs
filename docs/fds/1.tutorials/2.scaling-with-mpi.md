...
To verify the MPI/OpenMP setup, check the stderr logs in the [Inductiva Console](https://console.inductiva.ai) under the task details (**Task Logs → stderr.txt**), which should show:
