...
description: Explore supported FreeFEM versions and container images on the Inductiva.AI Cloud HPC platform.
seo:
 title: FreeFEM Versions and Docker Containers on Inductiva.AI
 description: Explore supported FreeFEM versions and container images on the Inductiva.AI Cloud HPC platform.
---
