...
description: Step-by-step guide to run your first CaNS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First CaNS Simulation on Inductiva.AI
 description: Step-by-step guide to run your first CaNS simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
