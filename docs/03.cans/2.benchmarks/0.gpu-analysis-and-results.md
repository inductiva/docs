...
description: ""
seo:
 title: CaNS Benchmarks on Inductiva.AI
 description: Explore CaNS performance benchmarks on the Inductiva.AI Cloud HPC platform. Compare scalability and cost efficiency across configurations.
---
...
[tutorial](../tutorials/run-temporal-boundary-layer-case).
