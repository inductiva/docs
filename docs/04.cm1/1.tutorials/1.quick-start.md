...
description: Step-by-step guide to run your first CM1 simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First CM1 Simulation on Inductiva.AI
 description: Step-by-step guide to run your first CM1 simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
