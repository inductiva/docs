...
- Work continues on the mechanism to save the output after a spot instance is preempted feature we previewed [last release](/guides/release-notes/v0-18/0.v0-18-0). We're making solid progress and expect to share more details very soon. 
