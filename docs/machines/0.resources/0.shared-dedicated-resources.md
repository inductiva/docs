...
- **Learn more**: [Machine Group documentation](machinegroup_class)


> For complete API documentation including all parameters, methods, and configuration options, see the [MachineGroup](/guides/api-functions/api/inductiva.resources#inductiva.resources.machine_groups.MachineGroup) class documentation
...
- **Learn more**: [Elastic Machine Group documentation](elasticgroup_class)


> For complete API documentation including all parameters, methods, and configuration options, see the [ElasticMachineGroup](/guides/api-functions/api/inductiva.resources#inductiva.resources.machine_groups.ElasticMachineGroup) class documentation
...
- **Learn more**: [MPI Cluster documentation](mpicluster_class)

> For complete API documentation including all parameters, methods, and configuration options, see the [MPICluster](/guides/api-functions/api/inductiva.resources#inductiva.resources.machine_groups.MPICluster) class documentation
...
the Inductiva API, we will run [SWASH](/guides/swash) Simulator on
`c2-standard-30` Google Cloud Platform (GCP) machines as an example. To keep costs down, we will use a preemptible [Spot Machine](../spot-machines).
