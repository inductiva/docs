...
- `spot` enables the use of [spot instances](machines/spot-machines). These are cheaper versions of the selected machine type, but they
...
[Inductiva CLI](/guides/api-functions/cli/index),
