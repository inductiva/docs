...
More info [here](machines/spot-machines).
...
> **Note:** Keep in mind that downloading incurs additional costs. You can check the pricing details [here](../..basics/how-much-does-it-cost).
