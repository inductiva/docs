...
More info [here](/guides/machines/spot-machines).
...
You can customize this using `max_idle_time` parameter in the [`MachineGroup` constructor](machines/computational_resources/machinegroup_class).
...
!["Project page in the Inductiva Console"](parallel-simulations/console-project.png)

4. Click on any task to open a detailed view.

!["Task details view in the Inductiva Console"](parallel-simulations/console-task.png)
...
> **Note:** Keep in mind that downloading incurs additional costs. You can check the pricing details [here](/guides/basics/how-much-does-it-cost).
