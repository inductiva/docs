...
description: Step-by-step guide to run your first XBeach simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First XBeach Simulation on Inductiva.AI
 description: Step-by-step guide to run your first XBeach simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
