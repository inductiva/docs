...
> 
> For a comprehensive guide on observer events with more advanced features and examples, see the [full Observer Events tutorial](/guides/optimize-workflow/alerts-events/).
