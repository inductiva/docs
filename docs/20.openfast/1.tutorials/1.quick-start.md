...
description: Step-by-step guide to run your first OpenFAST simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First OpenFAST Simulation on Inductiva.AI
 description: Step-by-step guide to run your first OpenFAST simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
