...
description: Step-by-step guide to run your first GX simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First GX Simulation on Inductiva.AI
 description: Step-by-step guide to run your first GX simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
