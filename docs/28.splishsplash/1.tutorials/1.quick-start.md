...
description: Step-by-step guide to run your first SPlisHSPlasH simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First SPlisHSPlasH Simulation on Inductiva.AI
 description: Step-by-step guide to run your first SPlisHSPlasH simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
