...
description: Step-by-step guide to run your first FUNWAVE simulation on Inductiva.AI. Easily launch, monitor and analyse results.
seo:
 title: Run Your First FUNWAVE Simulation on Inductiva.AI
 description: Step-by-step guide to run your first FUNWAVE simulation on Inductiva.AI. Easily launch, monitor and analyse results.
---
...
:raw-img{src="/funwave/funwave_animation.gif" alt="FUNWAVE simulation visualization" center}
